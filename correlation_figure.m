...
egfr_pos_Corr_low_patientMRN = mrn_low_half(duplicates_low) %set duplicates_low index as only values
egfr_neg_Corr_high_patientMRN = mrn_high_half;
egfr_neg_Corr_high_patientMRN(duplicates_high) = [] %set duplicates_high index to []